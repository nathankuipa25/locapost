    ...
    <main className="flex-1 bg-white">
      <div className="mx-auto w-full max-w-2xl px-5 py-6 sm:py-10">
        ...
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href="/create"
            className="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-xl bg-black px-4 text-sm font-medium text-white transition hover:bg-neutral-800 sm:self-auto"
          >
            <svg
              width="16"
              height="16"
